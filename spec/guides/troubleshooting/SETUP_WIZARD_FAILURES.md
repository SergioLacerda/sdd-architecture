...
**Quick Test:** `python packages/.sdd-wizard/SCRIPTS/setup-wizard.py --test`
...
**Symptom:**
```
$ python packages/.sdd-wizard/SCRIPTS/setup-wizard.py
...
# Retry wizard
python packages/.sdd-wizard/SCRIPTS/setup-wizard.py --load-profile
```
...
```bash
python packages/.sdd-wizard/SCRIPTS/setup-wizard.py --test
...
```bash
python packages/.sdd-wizard/SCRIPTS/setup-wizard.py 2>&1 | grep -i "seconds"
...
**Test:** `python packages/.sdd-wizard/SCRIPTS/setup-wizard.py --test`
