...
class PipelineBuilder:
    ...
    def __init__(self, core_path: str = "core"):
        ...
        # Compat: when tests run from `packages/`, "_spec" lives in the parent dir.
    ...
    def build(self) -> Dict[str, Any]:
        ...
        governancepackages = self._generate_json_structure(core_items, "CORE")
        governance_client = self._generate_json_structure(client_items, "CLIENT")

        # Calculate fingerprints
        core_fingerprint = self.calculate_fingerprint(governancepackages)
        governancepackages["fingerprint"] = core_fingerprint

        # Client fingerprint uses core fingerprint as salt
        client_fingerprint = self.calculate_fingerprint({**governance_client, "fingerprintpackages_salt": core_fingerprint})
        governance_client["fingerprint"] = client_fingerprint
        governance_client["fingerprintpackages_salt"] = core_fingerprint

        return {
            "governancepackages": governancepackages,
    ...
    def save_outputs(self, output_dir: str = "compiled") -> Dict[str, str]:
        ...
        core_data = result["governancepackages"]
        ...
        return {
            "governancepackages": str(core_file),
...
if __name__ == "__main__":
    ...
    print(f"  governance-core.json: {result['governancepackages']}")
