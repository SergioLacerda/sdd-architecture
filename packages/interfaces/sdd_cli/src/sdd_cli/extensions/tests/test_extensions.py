...
class TestExtensionRegistry:
    ...
    def test_get_mandates_all(self):
        ...
        class MockExtension(BaseExtension):
            metadata = ExtensionMetadata("Test", "1.0", "Author", "Desc", "test")
            mandates = [CustomMandate("M001", "HARD", "Test", "Test", category="general")]
            guidelines = []
...
class MockGameMasterExtension(BaseExtension):
    ...
    mandates = [CustomMandate("GMM001", "HARD", "Narrative State", "Test", category="architecture")]
    guidelines = [CustomGuideline("GMG01", "SOFT", "Random Generation", category="security")]
