...
class WizardOrchestrator:
    ...
    def _generate_deployment_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "templates_generated": len(list(self.templates_dir.glob("*.json"))),
            "fingerprints": {
