...
def filter_guidelines_by_language(guidelines: Dict, language: str) -> Tuple[Dict, List[str]]:
    """
...
def phase_4_filter_guidelines(guidelines: Dict, language: str = "python", repo_root: Path | None = None) -> Tuple[bool, Dict]:
    """
    ...
    language_filtered, language_removed = filter_guidelines_by_language(guidelines, language)
