...
class Phase456Generator:
    ...
    def __init__(self, repo_root: Path, output_base: Path, config: dict, verbose: bool = False):
        ...
        if self.repo_root.name == "packages":
        ...
        self.governancepackages = self.repo_root / "sdd-generated" / "final-output" / "governance-core.json"
        self.governance_client = self.repo_root / "sdd-generated" / "final-output" / "governance-client.json"

        # Template paths
        self.template_base = self.repo_root / "packages" / "wizard" / "templates" / "base"
    ...
    def load_governance(self) -> bool:
        ...
        self.log(f"Loading governance-core.json from {self.governancepackages}")

        if not self.governancepackages.exists():
            print(f"  ❌ governance-core.json not found: {self.governancepackages}")
            return False

        try:
            with open(self.governancepackages, "r") as f:
...
"""
    ...
    def generate_metadata(self) -> bool:
        ...
        try:
            ...
            metadata_file = self.dir / "metadata.json"
    ...
    def validate_output(self) -> Tuple[bool, Dict[str, Any]]:
        ...
        try:
            ...
            required_files = [
                ...
                (self.dir / "metadata.json", "Metadata"),
