...
class ArtifactLoader:
    ...
    def __init__(self, repo_root: Path | None = None):
        ...
        self.core = repo_root / "core"
        self.runtime = repo_root / "runtime"
    ...
    def load_compiled_mandate(self) -> Dict[str, Any]:
        ...
        mandate_bin = self.runtime / "mandate.bin"
        mandate_json = self.runtime / "mandate.json"
        ...
        raise FileNotFoundError(
            "Compiled mandate not found.\n"
            "Run: python compiler/compiler.py (from repository root)\n"
            "Expected: runtime/mandate.bin or runtime/mandate.json"
        )

    def load_compiled_guidelines(self) -> Dict[str, Any]:
        """Load COMPILED guidelines (JSON or msgpack)"""
        guidelines_bin = self.runtime / "guidelines.bin"
        guidelines_json = self.runtime / "guidelines.json"
        ...
        raise FileNotFoundError(
            "Compiled guidelines not found.\n"
            "Run: python compiler/compiler.py (from repository root)\n"
            "Expected: runtime/guidelines.bin or runtime/guidelines.json"
        )
...
def load_artifacts_safe(repo_root: Path | None = None) -> Tuple[bool, Dict[str, Any], list]:
    """
