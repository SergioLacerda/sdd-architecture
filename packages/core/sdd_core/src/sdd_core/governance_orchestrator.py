...
class GovernanceOrchestrator:
    ...
    def _run_phase_1(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Save outputs
            builder.save_outputs(str(self.compiled_dir))

            return {
                "core_fingerprint": result["governancepackages"]["fingerprint"],
    ...
    def get_deployment_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "artifacts": {
                ...
                "client_msgpack": str(self.compiled_dir / "governance-client-template.compiled.msgpack"),
