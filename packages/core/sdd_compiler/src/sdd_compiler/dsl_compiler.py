...
try:
    importlib.import_module("sdd_compiler.runtime_telemetry_kit")
    HAS_RTK = True
except ImportError:
    HAS_RTK = False
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print()
        print("Examples:")
        print("  python dsl_compiler.py core/mandate.spec")
        print("  python dsl_compiler.py core/guidelines.dsl output.json")
        sys.exit(1)
