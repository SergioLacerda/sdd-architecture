...
class GovernanceCompiler:
    ...
    def compile(self, output_dir: str = "compiled") -> Dict[str, Any]:
        """
        ...
        core_fingerprint_salt = client_data.get("fingerprintpackages_salt")
    ...
    def _generate_metadata(
        ...
        if file_type == "client-template":
            metadata["fingerprintpackages_salt"] = data.get("fingerprintpackages_salt")
    ...
    def validate_compilation(self, output_dir: str = "compiled") -> bool:  # noqa: C901
        """
        ...
        core_salt = client_meta.get("fingerprintpackages_salt")
