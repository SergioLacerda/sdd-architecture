...
class SDDIntegrator:
    ...
    def __init__(self, repo_root: Path = None):
        ...
        if repo_root is None:
            # Detect repo root: go up from sdd_compiler/src/ to find packages
            current = Path(__file__).parent.parent.parent  # compiler/src/ → packages
        ...
        self.repo = repo_root
        self.core = repo_root / "packages" / "core"
        self.spec = repo_root / "_spec"
        self.compiler = repo_root / "packages" / "compiler"
        self.runtime = repo_root / "packages" / "runtime"
    ...
    def run(self) -> bool:
        ...
        print("   Or import: from sdd_compiler.src.integrate import SDDIntegrator")
