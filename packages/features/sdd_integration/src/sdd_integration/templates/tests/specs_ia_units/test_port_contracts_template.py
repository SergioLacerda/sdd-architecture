...
COPY THIS FILE TO: tests/specs_ia_units/test_port_contracts.py
...
class TestPortContracts:
    ...
    def test_all_adapters_implement_ports(self):
        ...
        for file in adapter_files:
            ...
            if has_class_definition:
                ...
                assert has_inheritance, f"{file}: adapter doesn't inherit from anything (should implement port)"
    ...
    def test_storage_adapter_implements_storage_port(self):
        ...
        assert "StoragePort" in content or "class Storage" in content, "Storage adapter should reference StoragePort contract"
