...
class TestExecutionFlow:
    ...
    def test_canonical_layer(self):
        ...
        # Rules layer
        rules_files = ["rules/constitution.md", "rules/ia-rules.md", "rules/conventions.md"]
    ...
    def test_runtime_layer(self):
        ...
        runtime_files = ["search-keywords.md", "spec-canonical-index.md", "spec-guides-index.md"]
    ...
    def test_ai_first_design(self):
        ...
        ai_files = [".ai-index.md", "README.md", ".spec.config"]
