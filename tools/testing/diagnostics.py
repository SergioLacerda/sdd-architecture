...
class DiagnosticTestSuite:
    ...
    def testpackages_root_exists(self) -> Tuple[bool, str]:
    ...
    def run_all_tests(self) -> Dict[str, Any]:
        ...
        # File & Directory Tests
        self.run_test("Core packages/ directory", self.testpackages_root_exists, "structure")
        self.run_test("Core subsystems", self.testpackages_subsystems, "structure")
