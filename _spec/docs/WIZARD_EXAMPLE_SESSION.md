...
Examples: "Use Clean Architecture", "Write tests first"
  ...
  📄 mandate.spec
     Location: _core/.sdd-core/mandate.spec
     Size: 0.7 KB
...
Examples: "Documentation standards", "Naming conventions"
  ...
  📄 guidelines.dsl
     Location: _core/.sdd-core/guidelines.dsl
     Size: 27.6 KB
...
Project output directory [/home/sergio/dev/sdd-architecture/_core/sdd-generated/project]: 
```
**Você digita:** `<ENTER>` (usar default)

```
  ✅ Output: /home/sergio/dev/sdd-architecture/_core/sdd-generated/project
```
...
📖 NEXT STEPS:
  1. Read /home/sergio/dev/sdd-architecture/_core/sdd-generated/project/.ai/constitution.md to understand your rules
...
📚 LEARN MORE:
  • Constitution: /home/sergio/dev/sdd-architecture/_core/sdd-generated/project/.ai/constitution.md
  • Architecture: /home/sergio/dev/sdd-architecture/_core/sdd-generated/project/docs/ARCHITECTURE.md
  • Guidelines: /home/sergio/dev/sdd-architecture/_core/sdd-generated/project/.ai/governance-client.json
...
| O Quê | Localização |
|-------|-------------|
| **Arquivos Source** | `_core/.sdd-core/` |
| ├─ mandate.spec | `_core/.sdd-core/mandate.spec` |
| ├─ guidelines.dsl | `_core/.sdd-core/guidelines.dsl` |
| **Governança Compilada** | `_core/.sdd-compiled/` |
| ├─ governance-core.json | `_core/.sdd-compiled/governance-core.json` |
| ├─ governance-client.json | `_core/.sdd-compiled/governance-client.json` |
...
2. **Customize os sources se necessário**: Edite `_core/.sdd-core/mandate.spec` e `guidelines.dsl`, então rode o wizard novamente
3. **Verifique o diretório de saída**: Default é `_core/sdd-generated/project` - customize se precisar
