...
import pytest
from sdd_wizard.sdd_runtime.customization_template_generator import CustomizationTemplateGenerator
from sdd_wizard.sdd_runtime.governance_runtime_loader import GovernanceRuntimeLoader
from sdd_wizard.sdd_runtime.wizard_integrator import WizardIntegrator
...
class TestPhase5Runtime:
    ...
    def test_loader_loadspackages_governance(self, loader):
        """Test that loader can load core governance"""
        core = loader.loadpackages()
    ...
    def test_loader_validates_integrity(self, loader):
        ...
        assert loader.getpackages_fingerprint() is not None
    ...
    def test_loader_fingerprints_different(self, loader):
        ...
        core_fp = loader.getpackages_fingerprint()
    ...
    def test_fingerprint_preservation_through_runtime(self, loader):
        ...
        assert loader.getpackages_fingerprint() == core_fp
