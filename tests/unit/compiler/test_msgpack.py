...
class TestBenchmarking:
    ...
    def test_benchmark_speedup_realistic(self):
        ...
        data = {
            "mandates": [{"id": f"M{i:03d}", "type": "HARD", "title": f"Mandate {i}", "category": 1} for i in range(1, 20)],
            "guidelines": [
                {"id": f"G{i:02d}", "type": "SOFT", "title": f"Guideline {i}", "category": 2} for i in range(1, 50)
            ],
