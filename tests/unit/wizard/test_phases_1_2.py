...
from sdd_wizard.orchestration.phase_2_load_compiled import phase_2_load_compiled
...
class TestPhase1ValidateSource:
    ...
    def test_phase_1_detects_missing_mandate(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            (spec / "guidelines.dsl").write_text("guideline G001 { title: 'Test' }")
    ...
    def test_phase_1_detects_syntax_errors(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            (spec / "mandate.spec").write_text("mandate M001 { title: 'Test'")  # Missing }
            (spec / "guidelines.dsl").write_text("guideline G001 { title: 'Test' }")
...
class TestIntegration:
    ...
    def test_phases_1_and_2_complete_successfully(self):
        ...
        repo_root = Path(__file__).resolve().parents[3]  # .sdd-architecture
