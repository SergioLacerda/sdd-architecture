...
class TestCodeReviewGuardrail:
    ...
    def setup_method(self):
        ...
        # ADR files should exist in spec/architecture/decisions/
        self.adr_dir = self.repo_root / "spec" / "architecture" / "decisions"
        self.critical_files = [
    ...
    def test_adr_008_exists_and_complete(self):
        ...
        """
        adr_008 = REPO_ROOT / "spec" / "architecture" / "decisions" / "ADR-008-code-review-governance.md"
    ...
    def test_version_control_prevents_broken_versions(self):
        ...
        phases_dir = Path(REPO_ROOT / "packages" / "features" / "migration")
        phases_file = phases_dir / "PHASES.md" if phases_dir.exists() else None
