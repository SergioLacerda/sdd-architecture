...
----------------------------------------------------------------------
  ...
  📄 mandate.spec
     Location: _core/.sdd-core/mandate.spec      ← AQUI
     Size: 0.7 KB
...
----------------------------------------------------------------------
  ...
  📄 guidelines.dsl
     Location: _core/.sdd-core/guidelines.dsl    ← AQUI
     Size: 27.6 KB
...
### Onde estão os files:
- **Source 1:** `/home/sergio/dev/sdd-architecture/_core/.sdd-core/mandate.spec`
  - Contém: 2 mandates (M001, M002)
  - Tamanho: ~0.7 KB
  - Tipo: Regras HARD (obrigatórias)

- **Source 2:** `/home/sergio/dev/sdd-architecture/_core/.sdd-core/guidelines.dsl`
...
| #4 | Diretório saída? | Qualquer path | `_core/sdd-generated/project` |
...
```python
{
    'language': 'python',
    'mandates': ['M001', 'M002'],
    'output_dir': Path('/home/sergio/dev/sdd-architecture/_core/sdd-generated/project')
}
```
...
📍 YOUR PROJECT LOCATION:
   /home/sergio/dev/sdd-architecture/_core/sdd-generated/project  ← AQUI
...
```
📖 NEXT STEPS:
  1. Read /home/sergio/dev/sdd-architecture/_core/sdd-generated/project/.ai/constitution.md
...
**✅ Resposta:**
- PASSO 1 mostra: `_core/.sdd-core/mandate.spec` e `_core/.sdd-core/guidelines.dsl`
...
./wizard.sh
    ↓
PASSO 1: Mostra sources (_core/.sdd-core/mandate.spec, guidelines.dsl)
...
|-----------|---------|----------|
| Ver mandates | `_core/.sdd-core/mandate.spec` | Passo 1 - Preview |
| Ver guidelines | `_core/.sdd-core/guidelines.dsl` | Passo 1 - Preview |
