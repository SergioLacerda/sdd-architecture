...
**Triggers**: Push (paths: tests/, _core/), PR, Manual  
**Duration**: ~10 minutes
...
**Triggers**: Push (paths: _core/, tests/), PR, Manual  
**Duration**: ~8 minutes
...
| Lint fails | Formatting | `black _core/ tests/` |
| Health check fails | Missing files | Check `/core` structure |
| Governance fails | Policy violation | `python3 _core/governance_compliance.py --fix-steps` |
