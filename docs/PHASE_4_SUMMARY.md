...
Location: `_core/.sdd-wizard/templates/governance/`
...
**File**: `_core/governance_compliance.py`
...
**CLI Interface**
```bash
python3 _core/governance_compliance.py --verify          # Check compliance
python3 _core/governance_compliance.py --fix-steps       # Show remediation
python3 _core/governance_compliance.py --enforcement-check  # Show enforcement level
```

### 3. Integration Documentation (3 Files)

**File 1**: `_core/LAYER_4_INTEGRATION.md`
...
**File 2**: `_core/GOVERNANCE_QUIZ_EXTENSION.md`
...
**File 3**: `_core/E2E_TESTING_GUIDE.md`
...
| Integrate into AHP | _core/LAYER_4_INTEGRATION.md |
| Add quiz questions | _core/GOVERNANCE_QUIZ_EXTENSION.md |
| Run complete tests | _core/E2E_TESTING_GUIDE.md |
