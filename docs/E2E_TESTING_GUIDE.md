...
**Purpose**: Validate complete governance system integration from wizard to enforcement
...
ls -la _core/governance_compliance.py
ls -la EXECUTION/quiz_questions.json
ls -la _core/agent_handshake.py
```
...
```bash
# Make backup
cp _core/agent_handshake.py _core/agent_handshake.py.bak
...
```bash
python3 _core/agent_handshake.py --mode=compact
...
```bash
python3 _core/agent_handshake.py --mode=verbose
...
# Try to bypass
python3 _core/agent_handshake.py --force --skip-checks --mode=compact
...
python3 _core/agent_handshake.py --mode=silent --format=json > /tmp/ahp-result.json
...
python3 _core/governance_compliance.py --project-root=/tmp/nonexistent --verify
...
```bash
# Check Python syntax
python3 _core/governance_compliance.py --help

# Run with verbose error
python3 -u _core/governance_compliance.py --verify 2>&1
```
