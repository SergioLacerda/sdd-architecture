...
python packages/agent_handshake.py --force --skip-checks --mode=compact
```
...
git diff HEAD~ packages/agent_handshake.py | grep -A50 "_layer_4_governance_health"

# Then manually edit or:
git checkout HEAD -- packages/agent_handshake.py
```
