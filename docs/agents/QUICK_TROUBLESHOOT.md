...
|---------|-----------|-----|------|
| **Commit blocked** | Governance failure | `python3 packages/governance_compliance.py --fix-steps` | 2min |
| **Push blocked** | Health check <10/10 | `python3 packages/health_check.py --force-recheck` | 2min |
| **Agent won't start** | Handshake failed | `python3 packages/agent_handshake.py --verbose` | 3min |
| **Quiz won't run** | Missing questions | `git checkout origin/main -- packages/quiz_questions.json` | 1min |
...
| **Cache stale** | Old state | `rm -f packages/.sdd/agent_state.json` | <1min |
...
```bash
# Status checks
python3 packages/health_check.py                      # Quick (default)
python3 packages/health_check.py --verbose            # Detailed
python3 packages/health_check.py --force-recheck      # Fresh
python3 packages/health_check.py --category git       # Git only

# Governance
python3 packages/governance_compliance.py --verify    # Check
python3 packages/governance_compliance.py --fix-steps # Auto-fix
python3 packages/governance_compliance.py --enforcement-check

# Agent
python3 packages/agent_handshake.py                   # Check
python3 packages/agent_handshake.py --verbose         # Detailed
python3 packages/agent_handshake.py --force-recheck   # Fresh

# Quiz
python3 packages/quiz_executor.py                     # Interactive
python3 packages/quiz_executor.py --mode silent       # Auto-score
python3 packages/quiz_executor.py --topic governance  # Filter
