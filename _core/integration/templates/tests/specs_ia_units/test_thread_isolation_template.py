...
COPY THIS FILE TO: tests/specs_ia_units/test_thread_isolation.py
...
class TestThreadIsolation:
    ...
    def test_execution_state_tracks_threads(self):
        ...
        any(
            word in content
            for word in ["thread", "Thread", "concurrent", "Concurrent", "task", "Task", "parallel", "Parallel"]
        )
...
class TestConcurrencyPatterns:
    ...
    def test_valid_concurrency_patterns(self):
        ...
        if uses_threading:
            ...
            assert has_synchronization, "Project uses threading but no synchronization primitives found"
