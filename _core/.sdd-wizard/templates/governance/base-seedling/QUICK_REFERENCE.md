...
|------|---------|-----------------|
| Check governance status | `python _core/agent_handshake.py --mode=compact` | 🟢 HEALTHY (if adopted) |
...
| Validate compliance | `python _core/quiz_executor.py --topic=governance` | Score + topic breakdown |
