...
# Add parent directory to path to import wizard modules
sys.path.insert(0, str(Path(__file__).parent.parent.parent))
sys.path.insert(0, str(Path(__file__).parent.parent.parent / "wizard" / ".sdd-runtime"))


def load_governance_config(path: str) -> Dict[str, Any]:
    """Load governance configuration from wizard."""
    try:
