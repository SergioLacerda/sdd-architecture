...
from cli.utils.loader import get_governance_summary, load_governance_config, validate_governance_path
...
@app.command()
def load(path: str = typer.Option("wizard", help="Path to governance configuration")) -> None:
...
@app.command()
def validate(path: str = typer.Option("wizard", help="Path to governance configuration")) -> None:
...
def generate(
    ...
    path: str = typer.Option("wizard", help="Path to governance configuration"),
) -> None:
