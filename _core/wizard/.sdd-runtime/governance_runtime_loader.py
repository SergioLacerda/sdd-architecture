...
Load compiled msgpack artifacts from compiler/runtime/
...
class GovernanceRuntimeLoader:
    ...
    def __init__(self, compiled_dir: str = None):
        ...
        if compiled_dir is None:
            ...
            # File is at: repo/wizard/runtime/governance_runtime_loader.py
            repo_root = Path(__file__).parent.parent.parent.parent
            compiled_dir = repo_root / "_core" / "compiler" / "runtime"
        else:
