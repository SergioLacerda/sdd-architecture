...
class TestPhase6GenerateProject:
    ...
    def test_phase_6_basic_execution(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            success, report = phase_6_generate_project(
                mandates, guidelines, "mandate test", "guideline test", metadata, project_dir, language="python"
            )
    ...
    def test_phase_6_creates_project_directories(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            success, report = phase_6_generate_project(mandates, guidelines, "mandate", "guideline", metadata, project_dir)
    ...
    def test_phase_6_creates_specification_files(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            success, report = phase_6_generate_project(
                {"M001": {}}, {"G001": {}}, mandate_text, guideline_text, {"version": "3.0.0"}, project_dir
            )
    ...
    def test_phase_6_generates_language_specific_build_files(self):
        ...
        for language, expected_file in languages_and_files:
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                success, report = phase_6_generate_project(
                    {"M001": {}}, {"G001": {}}, "mandate", "guideline", {"version": "3.0.0"}, project_dir, language=language
                )
...
class TestPhase7ValidateOutput:
    ...
    def test_phase_7_checks_directory_structure(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Generate project
            phase_6_generate_project({"M001": {}}, {"G001": {}}, "mandate", "guideline", {"version": "3.0.0"}, project_dir)
