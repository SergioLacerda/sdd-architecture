...
Phase 1: Generate markdown templates with status fields
  Input: mandate.spec, guidelines.dsl from _core/core/
...
class Phase3Compiler:
    ...
    def copy_language_templates(self) -> bool:  # noqa: C901
        ...
        try:
            templates_dir = self.repo_root / "_core" / "wizard" / "templates"
    ...
    def copy_seedlings(self) -> bool:
        ...
        try:
            ...
            source_seedling_dir = self.repo_root / "_core" / "integration" / "templates"
