...
Copies template files from wizard/templates/ and applies language customizations
"""
...
def _copy_template_files(source_dir: Path, target_dir: Path, ignored_patterns: list = None) -> Tuple[int, list]:
