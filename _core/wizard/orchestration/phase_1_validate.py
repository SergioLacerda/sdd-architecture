...
# Add src directory to path (avoid collisions with third-party `src` packages)
sys.path.insert(0, str(Path(__file__).parent.parent / "src"))

from validator import SourceValidator


def phase_1_validate_source(repo_root: Path | None = None) -> Tuple[bool, Dict]:
    """
    Phase 1: Validate SOURCE layer (core/)

    Input: core/mandate.spec and core/guidelines.dsl
    ...
    # Check files exist
    mandate_file = core / "mandate.spec"
    guidelines_file = core / "guidelines.dsl"
